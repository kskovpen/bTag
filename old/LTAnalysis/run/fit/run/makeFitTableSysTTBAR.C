void makeFitTableSysTTBAR(std::string jtype)
{
   gROOT->SetBatch();
   ...
   const int nptbin = 5;
   std::string ptbinname[nptbin] = {"pt30t50","pt50t80","pt80t120","pt120t210","pt210t320"};
   std::string pt1[nptbin] = {"30","50","80","120","210"};
   std::string pt2[nptbin] = {"50","80","120","210","320"};
