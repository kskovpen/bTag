...
// Thu Sep 12 10:36:48 2013 by ROOT version 5.32/00
// from TTree ttree/ttree
// found on file: /opt/sbg/data/data3/cms/blochd/NTUPLES/CMSSW_5_3_11_V02-03-02/Data/BTag_Run2012A-22Jan2013/JetTree_data.root
//////////////////////////////////////////////////////////
...
////   TreeClass(TChain *ch=0,TTree *tree=0,char* fname="physics.root",std::string treename="physics");
   TreeClass(TChain *ch=0,char* fname="physics.root",std::string treename="physics");
   virtual ~TreeClass();
