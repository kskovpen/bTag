...
namespace LTANA
{
   ...
   class Reweight
	...
	// var / ptbin / bins / btag / v1,v2
	std::vector<std::vector<std::vector<std::vector<std::pair<float,float> > > > > rw2DBinX;
	std::vector<std::vector<std::vector<std::vector<std::pair<float,float> > > > > rw2DBinY;
	std::vector<std::vector<std::vector<std::vector<std::pair<float,float> > > > > rw2DSf;
