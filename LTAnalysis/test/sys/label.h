...
{   
   ...
   else if( strcmp(l.c_str(),"pt50t70") == 0 ) ptl+=" 50-70 GeV";
   else if( strcmp(l.c_str(),"pt70t100") == 0 ) ptl+=" 70-100 GeV";
   else if( strcmp(l.c_str(),"pt100t140") == 0 ) ptl+=" 100-140 GeV";
   else if( strcmp(l.c_str(),"pt140t250") == 0 ) ptl+=" 140-250 GeV";
   else if( strcmp(l.c_str(),"pt250t450") == 0 ) ptl+=" 250-450 GeV";
   else if( strcmp(l.c_str(),"pt450t670") == 0 ) ptl+=" 450-670 GeV";
   
   else if( strcmp(l.c_str(),"pt140t200") == 0 ) ptl+=" 140-200 GeV";
   else if( strcmp(l.c_str(),"pt200t300") == 0 ) ptl+=" 200-300 GeV";
   else if( strcmp(l.c_str(),"pt300t670") == 0 ) ptl+=" 300-670 GeV";
