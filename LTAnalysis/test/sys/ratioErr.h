...
void ratioErr(TCanvas *c1, TH1D* h1, TH1D* h2, TH1D *h1_low, TH1D *h1_up, std::string rw)
{
   ...
   h1c->GetYaxis()->SetTitle("MC(RW)/MC");
   ...
   if( rw == "njet" ) h1c->GetYaxis()->SetRangeUser(0.4,1.6);
   if( rw == "mupt" ) h1c->GetYaxis()->SetRangeUser(0.7,1.3);
   if( rw == "jeta" ) h1c->GetYaxis()->SetRangeUser(0.7,1.3);
   if( rw == "pt" ) h1c->GetYaxis()->SetRangeUser(0.7,1.3);
