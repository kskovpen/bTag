...
const int nptbin = 10;
std::string ptbin[nptbin] = { "nosel","pt20t30","pt30t50","pt50t70","pt70t100",
   "pt100t140","pt140t200","pt200t300","pt300t670","pt670t1000" };

const int nflav = 4;
std::string flav[nflav] = {"ajet_","bjet_","cjet_","ljet_"};

const int nbtag = 3;
std::string btag[nbtag] = {"_nosel","_CSVL","_UNTAGCSVL"};

//const int nbtag = 1;
//std::string btag[nbtag] = {"_nosel"};
