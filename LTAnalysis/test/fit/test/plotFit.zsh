...
"pt210t260" "pt260t320" "pt320t400" \
"pt400t500" "pt500t670")
#ptbin=("pt20t25" "pt25t30" "pt30t35" "pt35t40" \
...
ptbin=("pt30t50" "pt50t80" "pt80t120" \
"pt120t210" "pt210t320")
elif [[ $ana == 3 ]]; then
ptbin=("pt20t40" "pt40t60" "pt60t80" \
"pt80t120" "pt120t210" "pt210t320" \
"pt320t500" "pt500t1000")
fi
...
frB1=$frB1$dl$(echo $lineTAG1 | awk '{print $25;}')
frB2=$frB2$dl$(echo $lineTAG2 | awk '{print $25;}')

frC1=$frC1$dl$(echo $lineTAG1 | awk '{print $26;}')
frC2=$frC2$dl$(echo $lineTAG2 | awk '{print $26;}')

frL1=$frL1$dl$(echo $lineTAG1 | awk '{print $27;}')
frL2=$frL2$dl$(echo $lineTAG2 | awk '{print $27;}')
...
echo ${p1f1BTAG} >> ${outf} 
echo ${p2f1BTAG} >> ${outf}
echo ${p0errf1BTAG} >> ${outf}
echo ${p1errf1BTAG} >> ${outf}
echo ${p2errf1BTAG} >> ${outf}
echo ${p0f2BTAG} >> ${outf}
echo ${p1f2BTAG} >> ${outf}
echo ${p2f2BTAG} >> ${outf}
echo ${p0errf2BTAG} >> ${outf}
echo ${p1errf2BTAG} >> ${outf}
echo ${p2errf2BTAG} >> ${outf}
echo ${p0f3BTAG} >> ${outf}
echo ${p1f3BTAG} >> ${outf}
echo ${p2f3BTAG} >> ${outf}
echo ${p0errf3BTAG} >> ${outf}
echo ${p1errf3BTAG} >> ${outf}
echo ${p2errf3BTAG} >> ${outf}
...
root -l -b makeFitTableTTBAR.C
elif [[ $ana == 3 ]]; then
root -l -b makeFitTableBINV2.C
fi
...
if [[ $ana == 1 ]]; then
root -l -b makeFitTableSys.C\(\""bjet"\"\)
root -l -b makeFitTableSys.C\(\""cjet"\"\)
root -l -b makeFitTableSys.C\(\""ljet"\"\)
elif [[ $ana == 2 ]]; then
root -l -b makeFitTableSysTTBAR.C\(\""bjet"\"\)
root -l -b makeFitTableSysTTBAR.C\(\""cjet"\"\)
root -l -b makeFitTableSysTTBAR.C\(\""ljet"\"\)
elif [[ $ana == 3 ]]; then
root -l -b makeFitTableSysBINV2.C\(\""bjet"\"\)
root -l -b makeFitTableSysBINV2.C\(\""cjet"\"\)
root -l -b makeFitTableSysBINV2.C\(\""ljet"\"\)
fi
...
mv results/table_inc_heavy.tex results/table_inc_heavy_${sysOpt}.tex
elif [[ $ana == 3 ]]; then
mv results/table_inc_heavy.tex results/table_inc_heavy_${sysOpt}.tex
fi
