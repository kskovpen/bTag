void makeFitTableSysBINV2(std::string jtype)
{
   gROOT->SetBatch();
   ...
   const int nptbin = 8;
   std::string ptbinname[nptbin] = {"pt20t40","pt40t60","pt60t80","pt80t120","pt120t210","pt210t320","pt320t500","pt500t1000"};
   std::string pt1[nptbin] = {"20","40","60","80","120","210","320","500"};
   std::string pt2[nptbin] = {"40","60","80","120","210","320","500","1000"};
