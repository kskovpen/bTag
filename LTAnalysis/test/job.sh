...
echo "Executing .././LTAnalysis ${line2} ${dout}${fout} ${isdata} ${noe} ${xsec} ${eff} ${nmax} ${doRW} ${tool} ${samptype}"
${dout}/.././LTAnalysis ${line2} ${dout}${fout} ${isdata} ${noe} ${xsec} ${eff} ${nmax} ${doRW} ${tool} ${samptype}
